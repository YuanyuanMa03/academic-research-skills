...
```bash
cd plugins/sd-export/skills/sd-export && python scripts/push_to_zotero.py --ris-file "{RIS_FILE_PATH}"
```

Or push RIS content directly:

```bash
cd plugins/sd-export/skills/sd-export && python scripts/push_to_zotero.py --ris-data "{RIS_CONTENT}"
```
...
```bash
cd plugins/sd-export/skills/sd-export && python scripts/push_to_zotero.py "{JSON_FILE_PATH}"
```
...
```bash
cd plugins/sd-export/skills/sd-export && python scripts/push_to_zotero.py --list
```
